...
#La
corteLa_Am=[367-8, 394+8]
p0_La_Am=[0,1,30,379-8,3]
...
#Lb1 y Lb2
corteLb_Am=[445-8, 500+8]
p0_Lb_Am=[0,459+8,3,30,481-8,3]
...
#Ma
corteMa_Am=[60-8, 120+8]
p0_Ma_Am=[0,1,0,91+8,3]
...
# print(parametrosMa_Am)
#Lg
corteLg_Am=[553-8, 580+8]
p0_Lg_Am=[0,1,24,564+8,3]
...
#Ll
corteLl_Am=[308-8, 337+8]
p0_Ll_Am=[0,1,5,322+8,3]
...
# #Ma y Mg
# corteM_Am=[73-8,113+8]
# p0_M_Am=[16,90+8,0.2,14,102+8,0.3]
# xM_Am, yM_Am, xerrM_Am, yerrM_Am = cortar_datos(corteM_Am[0], corteM_Am[1], x_Am, y_Am, x_Am_err, y_Am_err)
# parametrosM_Am, erroresM_Am, _, _ = ajustar_gaussiana_doble_odr(xM_Am, yM_Am, xerrM_Am, yerrM_Am, p0_M_Am, True)

#Ma y Mg
corteM_Am=[73-8,113+8]
p0_M_Am=[16,90+8,0.2,14,0.3]
xM_Am, yM_Am, xerrM_Am, yerrM_Am = cortar_datos(corteM_Am[0], corteM_Am[1], x_Am, y_Am, x_Am_err, y_Am_err)
parametrosM_Am, erroresM_Am, _, _ = ajustar_gaussiana_odr(xM_Am, yM_Am, xerrM_Am, yerrM_Am, p0_M_Am, True)

E=[3.664,11.871,13.946,16.794,17.751,20.784]
errE=[0.001,0.001,0.001,0.001,0.001,0.001]
canal=[parametrosM_Am[1],parametrosLl_Am[3],parametrosLa_Am[3],parametrosLb_Am[1],parametrosLb_Am[4],parametrosLg_Am[3]]
errCanal=[erroresM_Am[1],erroresLl_Am[3],erroresLa_Am[3],erroresLb_Am[1],erroresLb_Am[4],erroresLg_Am[3]]

m, sm, b, sb, r2 = fit_lineal(canal,E,errCanal,errE,True,"Canal","Energpia [keV]","Calibración Am-241")
